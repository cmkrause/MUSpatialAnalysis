...
def raceContigencyAnalysis(race):
    ...
    rowQueries = ["Gi_Bin >= 1", "Gi_Bin = 0", "Gi_Bin <= -1"]
    columnQueries = ["CONTROL = 1", "CONTROL = 2", "CONTROL = 3"]

    rowNames = ["Hot Spots", "Neither", "Cold Spots"]
    columnNames = ["Public", "Private Non-Profit", "Private For-Profit"]
